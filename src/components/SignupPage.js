				...
				<div className="card">
					...
					<div className="card-body">
						<form>
							...
							<div className="form-group row mb-3">
								<label for="contact" className="col-sm-3 col-form-label">Contact number:</label>
								<div className="col-sm-9">
									<input type="tel" className="form-control" id="contact" placeholder="Enter your contact number"/>
								</div>
							</div>
							<div className="form-group row mb-3">
								<label for="interests" className="col-sm-3 col-form-label">Area of interest:</label>
								<div className="col-sm-9">
							...
							<div className="form-group row mb-3">
								<label for="income" className="col-sm-3 col-form-label">Gross income:</label>
								<div className="col-sm-9">
									<input type="number" className="form-control" id="income" placeholder="Enter your gross income"/>
								</div>
							</div>
							<div className="form-group row mb-3">
								<label for="networth" className="col-sm-3 col-form-label">Net worth:</label>
								<div className="col-sm-9">
									<input type="number" className="form-control" id="networth" placeholder="Enter your net worth"/>
								</div>
							</div>
							<div className="form-group row mb-3">
